...
const imprimirPesoInicial = ({ nombre, peso }) => console.log(`Día 1 ${nombre} pesa: ${peso}`)
...
const imprimirPesoFinal = ({ nombre, peso }) => {
    console.log(`A ${nombre} le llevo ${dias} días para llegar a la meta. Ahora pesa: ${peso.toFixed(2)}`)
}
